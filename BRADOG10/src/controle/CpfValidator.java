...
public class CpfValidator implements Validator {
	@Override
	public void validate(FacesContext arg0, UIComponent component, Object valor) throws ValidatorException {
		String v = valor.toString();
		String cpf = v.replaceAll("\\D", "");
		if (!isCPF(cpf)) {
			FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_FATAL, "CPF inválido", "");
